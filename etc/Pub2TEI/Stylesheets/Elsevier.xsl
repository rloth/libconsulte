...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <!-- biblio RL: sb:conference -->
    <xsl:template match="els:conf-name | sb:conference">
        <meeting>
            <xsl:apply-templates/>
        </meeting>
    </xsl:template>
    
    <!-- biblio RL: sb:comment -->
    ...
    <!-- RL: removed ce:suffix template, e.g. jr for junior already 
        covered in NameComponents => tei:genName -->
